; ModuleID = '/home/lucasrj/github/embeded_systems/hls/assigment2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream"* %A, %"class.hls::stream"* nonnull align 512 %A_copy, %"class.hls::stream"* %B, %"class.hls::stream"* nonnull align 512 %B_copy)
  call void @apatb_example_hw(%"class.hls::stream"* %A_copy, %"class.hls::stream"* %B_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %A, %"class.hls::stream"* nonnull align 512 %A_copy, %"class.hls::stream"* %B, %"class.hls::stream"* nonnull align 512 %B_copy)
  ret void
}
