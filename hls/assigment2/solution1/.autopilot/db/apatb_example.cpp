...
{sc_bv<96> xlx_stream_B_pc_buffer;
unsigned xlx_stream_B_size = 0;

          std::vector<sc_bv<32> > B_V_data_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > B_V_data_V_pc_buffer;
          int i = 0;
...
B_V_data_V_pc_buffer_Copy=B_V_data_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > B_V_keep_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > B_V_keep_V_pc_buffer;
          int i = 0;
...
B_V_keep_V_pc_buffer_Copy=B_V_keep_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > B_V_strb_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > B_V_strb_V_pc_buffer;
          int i = 0;
...
B_V_strb_V_pc_buffer_Copy=B_V_strb_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > B_V_last_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > B_V_last_V_pc_buffer;
          int i = 0;
...
xlx_stream_B_pc_buffer.range(31, 0) = B_V_data_V_pc_buffer_Copy[j];
xlx_stream_B_pc_buffer.range(39, 32) = B_V_keep_V_pc_buffer_Copy[j];
xlx_stream_B_pc_buffer.range(47, 40) = B_V_strb_V_pc_buffer_Copy[j];
xlx_stream_B_pc_buffer.range(63, 56) = B_V_last_V_pc_buffer_Copy[j];
__cosim_sC__ xlx_stream_elt;
((long long*)&xlx_stream_elt)[0*1+0] = xlx_stream_B_pc_buffer.range(63,0).to_int64();
((long long*)&xlx_stream_elt)[0*1+1] = xlx_stream_B_pc_buffer.range(95,64).to_int64();
((hls::stream<__cosim_sC__>*)__xlx_apatb_param_B)->write(xlx_stream_elt);
}}
    AESL_transaction_pc++;
    return ;
  }
...
sc_bv<96> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_B_stream_buf[__xlx_apatb_param_B_stream_buf_size+j])[0*1+0];
__xlx_tmp_lv.range(95,64) = ((long long*)&__xlx_apatb_param_B_stream_buf[__xlx_apatb_param_B_stream_buf_size+j])[0*1+1];
sc_bv<32> __xlx_tmp_0_lv = __xlx_tmp_lv.range(31, 0);
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_B_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_1_lv = __xlx_tmp_lv.range(39, 32);
