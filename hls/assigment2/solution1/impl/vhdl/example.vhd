...
architecture behav of example is 
    ...
    signal tmp_last_V_fu_96_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, ap_CS_fsm_state4, regslice_both_B_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (regslice_both_B_V_data_V_U_apdone_blk = ap_const_logic_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
    ...
    A_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0, A_TVALID_int_regslice)
    begin
    ...
    A_TREADY_int_regslice_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    B_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, B_TREADY_int_regslice)
    begin
    ...
    B_TDATA_int_regslice <= std_logic_vector(unsigned(ap_const_lv32_FF) - unsigned(A_TDATA_int_regslice));
    B_TVALID <= regslice_both_B_V_data_V_U_vld_out;

    B_TVALID_int_regslice_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, A_TVALID_int_regslice, B_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_0 = B_TREADY_int_regslice)) or ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and ((ap_const_logic_0 = B_TREADY_int_regslice) or (ap_const_logic_0 = A_TVALID_int_regslice))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, A_TVALID_int_regslice, B_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_0 = B_TREADY_int_regslice)) or ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and ((ap_const_logic_0 = B_TREADY_int_regslice) or (ap_const_logic_0 = A_TVALID_int_regslice))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, A_TVALID_int_regslice, B_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_0 = B_TREADY_int_regslice)) or ((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and ((ap_const_logic_0 = B_TREADY_int_regslice) or (ap_const_logic_0 = A_TVALID_int_regslice))));
    end process;


    ap_block_state2_pp0_stage0_iter0_assign_proc : process(A_TVALID_int_regslice, B_TREADY_int_regslice)
    begin
                ap_block_state2_pp0_stage0_iter0 <= ((ap_const_logic_0 = B_TREADY_int_regslice) or (ap_const_logic_0 = A_TVALID_int_regslice));
    end process;


    ap_block_state3_pp0_stage0_iter1_assign_proc : process(B_TREADY_int_regslice)
    begin
                ap_block_state3_pp0_stage0_iter1 <= (ap_const_logic_0 = B_TREADY_int_regslice);
    end process;


    ap_condition_pp0_flush_enable_assign_proc : process(ap_CS_fsm_pp0_stage0, tmp_last_V_fu_96_p1, ap_block_pp0_stage0_subdone)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_last_V_fu_96_p1 = ap_const_lv1_1))) then 
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state4, regslice_both_B_V_data_V_U_apdone_blk)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (regslice_both_B_V_data_V_U_apdone_blk = ap_const_logic_0))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state4, regslice_both_B_V_data_V_U_apdone_blk)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (regslice_both_B_V_data_V_U_apdone_blk = ap_const_logic_0))) then 
    ...
    tmp_last_V_fu_96_p1 <= A_TLAST_int_regslice;
end behav;
