...
#(parameter
    ...
    input  wire [19:0]                   in_r_address0,
    input  wire                          in_r_ce0,
    output wire [31:0]                   in_r_q0,
    input  wire [19:0]                   out_r_address0,
...
//------------------------Parameter----------------------
localparam
    ADDR_AP_CTRL    = 24'h000000,
    ADDR_GIE        = 24'h000004,
    ADDR_IER        = 24'h000008,
    ADDR_ISR        = 24'h00000c,
    ADDR_IN_R_BASE  = 24'h400000,
    ADDR_IN_R_HIGH  = 24'h7fffff,
    ADDR_OUT_R_BASE = 24'h800000,
    ADDR_OUT_R_HIGH = 24'hbfffff,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,
    WRRESET         = 2'd3,
...
assign int_in_r_address1  = ar_hs? raddr[21:2] : waddr[21:2];
...
assign int_out_r_address1 = ar_hs? raddr[21:2] : waddr[21:2];
