...
architecture behave of example_AXI_CPU_s_axi is
    ...
    constant ADDR_IN_R_BASE  : INTEGER := 16#400000#;
    constant ADDR_IN_R_HIGH  : INTEGER := 16#7fffff#;
    constant ADDR_OUT_R_BASE : INTEGER := 16#800000#;
    constant ADDR_OUT_R_HIGH : INTEGER := 16#bfffff#;
    ...
    -- memory signals
    signal int_in_r_address0   : UNSIGNED(19 downto 0);
    ...
    signal int_in_r_address1   : UNSIGNED(19 downto 0);
    ...
    signal int_out_r_address0  : UNSIGNED(19 downto 0);
    ...
    signal int_out_r_address1  : UNSIGNED(19 downto 0);
...
-- ----------------------- Instantiation------------------
-- int_in_r
int_in_r : example_AXI_CPU_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 1000000,
     AWIDTH   => log2(1000000))
...
-- ----------------------- Memory logic ------------------
    ...
    int_in_r_address1    <= raddr(21 downto 2) when ar_hs = '1' else waddr(21 downto 2);
    ...
    int_out_r_address1   <= raddr(21 downto 2) when ar_hs = '1' else waddr(21 downto 2);
