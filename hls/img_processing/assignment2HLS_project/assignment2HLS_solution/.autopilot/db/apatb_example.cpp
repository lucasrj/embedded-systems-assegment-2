...
// wrapc file define:
#define AUTOTB_TVIN_in "../tv/cdatafile/c.example.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in "../tv/cdatafile/c.example.autotvout_in_r.dat"
// wrapc file define:
#define AUTOTB_TVIN_out "../tv/cdatafile/c.example.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out "../tv/cdatafile/c.example.autotvout_out_r.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_in "../tv/rtldatafile/rtl.example.autotvout_in_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_out "../tv/rtldatafile/rtl.example.autotvout_out_r.dat"
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > out_pc_buffer(1000000);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 1000000; j < e; j += 1, ++i) {
            ((int*)__xlx_apatb_param_out)[j] = out_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
...
// print in Transactions
{
  ...
  if (__xlx_apatb_param_in) {
    for (int j = 0  - 0, e = 1000000 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_in)[j];
  ...
  tcl_file.set_num(1000000, &tcl_file.in_depth);
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_out)[j];
  ...
  tcl_file.set_num(1000000, &tcl_file.out_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_out, __xlx_sprintf_buffer.data());
}
