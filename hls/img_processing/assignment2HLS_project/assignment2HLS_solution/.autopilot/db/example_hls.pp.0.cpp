...
# 24 "../../../Downloads/example_hls.cpp" 2




__attribute__((sdx_kernel("example", 0))) void example(volatile int in[1000][1000], volatile int out[1000][1000]) {_ssdm_SpecArrayDimSize(in, 1000);_ssdm_SpecArrayDimSize(out, 1000);
#pragma HLS TOP name=example
# 28 "../../../Downloads/example_hls.cpp"
...
#pragma HLS INTERFACE s_axilite port=out bundle=AXI_CPU
 ...
 int pictureLenght = 480;
 VITIS_LOOP_38_1: for (int i = 0; i < pictureWidth; i++)
 {
  VITIS_LOOP_40_2: for(int k = 0; k < pictureLenght; k++)
  {

#pragma HLS unrool factor = 4
 out[i][k] = max_pixel_val - in[i][k];
  }
 }
