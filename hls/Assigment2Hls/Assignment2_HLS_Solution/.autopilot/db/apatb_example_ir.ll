; ModuleID = '/home/oliver/Documents/Study/Embedded/Assigment2/embedded-systems-assegment-2/hls/Assigment2Hls/Assignment2_HLS_Solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_example_ir(%"class.hls::stream"* %in, %"class.hls::stream"* %out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_example_hw(%"class.hls::stream"* %in_copy, %"class.hls::stream"* %out_copy)
