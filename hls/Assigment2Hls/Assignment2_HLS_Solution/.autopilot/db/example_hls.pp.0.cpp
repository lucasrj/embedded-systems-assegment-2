...
__attribute__((sdx_kernel("example", 0))) void example(hls::stream<ap_axis<32,2,5,6>> &in, hls::stream<ap_axis<32,2,5,6>> &out) {
#pragma HLS TOP name=example
# 8 "../../../../../../Downloads/example_hls.cpp"
