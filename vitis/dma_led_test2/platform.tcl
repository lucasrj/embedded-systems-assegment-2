...
# xsct /home/lucasrj/github/embedded-systems-assegment-2/vitis/dma_led_test2/platform.tcl
# 
# OR launch xsct and run below command.
# source /home/lucasrj/github/embedded-systems-assegment-2/vitis/dma_led_test2/platform.tcl
# 
# To create the platform in a different location, modify the -out option of "platform create" command.
# -out option specifies the output directory of the platform project.

platform create -name {dma_led_test2}\
