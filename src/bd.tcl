...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set GPIO [ create_bd_port -dir O -from 0 -to 0 GPIO ]
  ...
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins axi_dma_0/s_axis_s2mm_tdata] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_ports GPIO] [get_bd_pins xlslice_0/Dout]
